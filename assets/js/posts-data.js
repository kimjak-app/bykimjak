  ...
  window.ALL_POSTS = [
    {
      ...
      sub: '6월 30일 대화록을 오늘 다시 꺼내 채코치에게 물었다',
      date: '2026-09-18', dl: '2026 · 09 · 18'
    },
    {
      url: 'posts/think/think-007.html',
    ...
    },
    {
      ...
      sub: '제작 지원 확정 소식과 잠언 16장 9절',
      date: '2026-09-16', dl: '2026 · 09 · 16'
    },
    {
      url: 'make/eastwar-devlog-042.html',
      catKey: 'eastwar', cat: 'Architect Notes',
      title: '월드맵 리팩토링',
      sub: '24,762줄짜리 파일이 통째로 날아간 날을 딛고, 외교·무역·첩보를 분리하다',
      date: '2026-09-14', dl: '2026 · 09 · 12–14'
    },
    {
      url: 'make/eastwar-devlog-041.html',
      catKey: 'eastwar', cat: 'Architect Notes',
      title: '게임에 소리가 생긴 날',
      sub: '브랜치 세 개, 효과음을 안전하게 합치는 법',
    ...
    },
    {
      ...
      catKey: 'morning-word', cat: 'Morning Word',
      title: '9월 첫주 아침 스타트!',
      sub: '《악마의 레시피》 대본 수정, 삼국워 작업, 그리고 어머니와의 여행',
      date: '2026-09-07', dl: '2026 · 09 · 07'
    },
    {
      url: 'posts/think/morning-word-035.html',
      catKey: 'morning-word', cat: 'Morning Word',
      title: '오늘 아침 일 많이 했다',
      sub: '냉장고를 살피고, 블로그 작업선을 넘기고, 다시 《악마의 레시피》로',
    ...
    },
    {
      ...
      catKey: 'morning-word', cat: 'Morning Word',
      title: '9월 출발!',
      sub: '하얗게 불태울 준비 끝. 달리자!',
      date: '2026-09-01', dl: '2026 · 09 · 01'
    },
    {
      url: 'posts/think/morning-word-033.html',
      catKey: 'morning-word', cat: 'Morning Word',
      title: '제출의 날, 그리고 다짐',
      sub: '8월 마지막 일요일, 동해를 보고 다짐한 것',
      date: '2026-08-31', dl: '2026 · 08 · 31'
    },
    {
    ...
    },
    {
      ...
      sub: '더 클리너 수정, 귀의 레시피 8화, 삼국워 모두의 창업 제출까지',
      date: '2026-08-24', dl: '2026 · 08 · 24'
    },
    {
      url: 'make/eastwar-devlog-034.html',
      catKey: 'eastwar', cat: 'Architect Notes',
      title: '한반도 MVP 번외 작업 — 임진왜란전 작업',
      sub: '44명에서 시작해 갑판전의 밑돌까지',
      date: '2026-08-23', dl: '2026 · 08 · 23'
    },
    {
      url: 'posts/think/morning-word-029.html',
      catKey: 'morning-word', cat: 'Morning Word',
      title: '포기는 배추 셀 때나 하는 거지',
      sub: '귀의 레시피 7화 통합, 삼국워 임진왜란 데모, 그리고 갈라디아서 6:9',
      date: '2026-08-23', dl: '2026 · 08 · 23'
    },
    {
      url: 'posts/think/morning-word-028.html',
      catKey: 'morning-word', cat: 'Morning Word',
      title: '네 손이 일을 얻는 대로',
    ...
    },
    {
      ...
      catKey: 'personal-essay', cat: 'Essay',
      title: 'AI 작문 활용법 - 창작, 코치, 듀얼모드',
      sub: '어제 글 작업을 하면서, 듀얼모드가 태어난 밤',
      date: '2026-08-21', dl: '2026 · 08 · 21'
    },
    {
      url: 'posts/think/morning-word-027.html',
      catKey: 'morning-word', cat: 'Morning Word',
      title: '8월은 활주로, 9월은 이륙',
      sub: '나머지 8월의 계획과 9월 계획 안',
      date: '2026-08-18', dl: '2026 · 08 · 18'
    },
    {
      url: 'posts/think/morning-word-026.html',
      catKey: 'morning-word', cat: 'Morning Word',
      title: '품위 있고, 질서 있게',
      sub: '"나가! 도저히 못 참겠어" — 수련회 후 정리와 경계의 꿈을 꾸고',
      date: '2026-08-17', dl: '2026 · 08 · 17'
    },
    {
      url: 'make/eastwar-devlog-033.html',
      catKey: 'eastwar', cat: 'Architect Notes',
      title: '전투 HUD의 마지막 조각들',
      sub: '전장 보급창, 중앙 정보 HUD, 조판의 1차 완성',
      date: '2026-08-14', dl: '2026 · 08 · 14'
    },
    {
      url: 'posts/think/morning-word-025.html',
      catKey: 'morning-word', cat: 'Morning Word',
      title: '더 높은 대본으로 가기 위해 — 피드백을 발판삼아',
      sub: '작가 2.0 첫 월요일, 피드백을 코치 기준표로 바꾸는 법, 그리고 이사야의 말씀',
      date: '2026-08-10', dl: '2026 · 08 · 10'
    },
    {
      url: 'posts/think/morning-word-024.html',
      catKey: 'morning-word', cat: 'Morning Word',
      title: '잘 써야 한다가 아니라, 피하지 않고 쓴다',
      sub: '토요일 자정을 넘긴 걱정, 그리고 일요일 아침의 다짐',
    ...
    },
    {
      ...
      sub: '그제 중앙 HUD, 어제 로스터창. 이틀 만에 넘어온 진전, 그리고 아부 없이 들은 진짜 통찰',
      date: '2026-08-04', dl: '2026 · 08 · 04'
    },
    {
      url: 'make/eastwar-devlog-031.html',
      catKey: 'eastwar', cat: 'Architect Notes',
      title: '그림 한 장이 왜 안 됐을까',
      sub: '삼국WAR 전투 UI, 이틀의 기록',
      date: '2026-08-02', dl: '2026 · 08 · 02'
    },
    {
      url: 'posts/think/morning-word-020.html',
      catKey: 'morning-word', cat: 'Morning Word',
      title: '실패는 미래의 자산이자 설계도다',
      sub: 'EASTWAR 상용화의 갈림길 — 그래픽 업그레이드 실패로 코치들과 나눈 이야기',
      date: '2026-08-02', dl: '2026 · 08 · 02'
    },
    {
      url: 'make/eastwar-devlog-030.html',
      catKey: 'eastwar', cat: 'Architect Notes',
      title: '화면 속 전투가 진짜로 살아났다',
      sub: '컷인 표준화부터 다부대 AI까지, 시스템이 된 연출',
      date: '2026-07-31', dl: '2026 · 07 · 31'
    },
    {
      url: 'make/eastwar-devlog-029.html',
      catKey: 'eastwar', cat: 'Architect Notes',
      title: '장수가 살아 움직이기 시작한다',
      sub: '39명의 장수 데이터, 역할, 병종, 고유기, 기세 시스템 재설계',
      date: '2026-07-28', dl: '2026 · 07 · 28'
    },
    {
      url: 'posts/think/morning-word-019.html',
      catKey: 'morning-word', cat: 'Morning Word',
      title: '떨면서도 끝내 해내는 사람',
      sub: '새 투자자와 회사를 찾아나서는 두려움, 그리고 빌립보서의 말씀',
